...
def file_db_handle(user_data,conn_params):
    ...
    elif user_data["account_role"] == "sadmin":
        return conn_params["sadmin_path"]
    elif user_data["account_role"] == "administor":
        return conn_params["administor_path"]
    else:
        print("角色不对..")
...
def db_handler(user_data):
    ...
    elif conn_params['engine'] == 'mysql':   #预留的mysql接口。
        pass

    elif conn_params['engine'] == 'sqlate':
        pass
